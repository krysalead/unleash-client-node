...
var Storage = /** @class */ (function (_super) {
    ...
    function Storage(_a) {
        ...
        _this.ready = false;
        _this.data = {};
        _this.path = (0, path_1.join)(backupPath, "/unleash-repo-schema-v1-" + _this.safeAppName(appName) + ".json");
        _this.load();
        return _this;
    }
    ...
    Storage.prototype.persist = function () {
        var _this = this;
        (0, fs_1.writeFile)(this.path, JSON.stringify(this.data), function (err) {
            if (err) {
    ...
    Storage.prototype.load = function () {
        var _this = this;
        (0, fs_1.readFile)(this.path, 'utf8', function (err, data) {
            if (_this.ready) {
                return;
            }
            if (err) {
